    ...
    function aboutController($location, $rootScope, $http) {
        ...
        function About() {
            vm.dataLoading = true;
             ...
             $http.post('http://speech-backend.herokuapp.com/account/About/', { username: vm.username, password: vm.password, first_name : vm.first_name, last_name: vm.last_name, email: vm.email})//, config)
