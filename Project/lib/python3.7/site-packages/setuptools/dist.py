...
def read_pkg_file(self, file):
    ...
    self.author_email = _read_field('author-templates')
...
def write_pkg_file(self, file):
    ...
    if version < StrictVersion('1.2'):
        ...
        write_field('Author-templates', self.get_contact_email())
    else:
        optional_fields = (
            ('Author', 'author'),
            ('Author-templates', 'author_email'),
            ('Maintainer', 'maintainer'),
            ('Maintainer-templates', 'maintainer_email'),
        )
